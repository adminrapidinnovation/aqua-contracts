...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAquaComp; // this vault is purely for staking. eg. WBNB-AQUA staking vault.
    ...
    address public aquaFarmAddress;
    ...
    uint256 public controllerFee = 0; // 50;  0.5%(auto-compounding fee)
    uint256 public constant controllerFeeMax = 10000; // 100 = 1%
    uint256 public constant controllerFeeUL = 300;

    uint256 public buyBackRate = 0; // 100;  1%(buy-back and burn fee)
    ...
    address[] public earnedToAQUAPath;
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(aquaFarmAddress, _wantAmt);
...
interface IBelt4Pool {
    function add_liquidity(uint256[4] memory amounts, uint256 min_mint_amount)
        external;
}

contract AquaStrategy_BELT is StratX2 {
    address public belt4PoolAddress;
    ...
    constructor(
        ...
        bool _isAquaComp,
        address[] memory _earnedToAQUAPath,
        ...
        uint256 _entranceFeeFactor,
        uint256 _withdrawFeeFactor,
        address _belt4PoolAddress
    ) public {
        wbnbAddress = _addresses[0];
        govAddress = _addresses[1];
        aquaFarmAddress = _addresses[2];
        ...
        isAquaComp = _isAquaComp;

        uniRouterAddress = _addresses[9];
        earnedToAQUAPath = _earnedToAQUAPath;
    ...
    function earn() public override nonReentrant whenNotPaused {
        ...
        if (token0Amt > 0) {
            ...
            IBelt4Pool(belt4PoolAddress).add_liquidity([0, 0, 0, token0Amt], 0);
        }
